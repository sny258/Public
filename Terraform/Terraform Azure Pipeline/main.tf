terraform {
  backend "azurerm" {
    storage_account_name = "azureterraformstorage"
    container_name       = "azureterraformstoragecontainer"
    key                  = "xxxxxxxxxxxxxp2pdah/bpmQBHirBXsqpesqe3e/SIv4RnTdNaZVdOUtW0/o2/4A=="
    sas_token            = "xxxxxxxxxxxxxxxxxxxxxxxxxx"
  }
}
